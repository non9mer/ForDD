Подлежащий анализу текстовый файл необходимо разместить в корневой папке проекта (bin/Debug/net5.0). Выходной файл будет создан там же с именем .stats.txt.
